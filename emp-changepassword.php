                                ...
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="oldPassword" type="password" class="validate" autocomplete="off" name="password" required>
                                            <label for="oldPassword">รหัสผ่านเดิม</label>
                                            <span toggle="#oldPassword" class="field-icon toggle-password"><i class="material-icons">visibility</i></span>
                                        </div>

                                        <div class="input-field col s12">
                                            <input id="newPassword" type="password" name="newpassword" class="validate" autocomplete="off" required>
                                            <label for="newPassword">รหัสผ่านใหม่</label>
                                            <span toggle="#newPassword" class="field-icon toggle-password"><i class="material-icons">visibility</i></span>
                                        </div>

                                        <div class="input-field col s12">
                                            <input id="confirmPassword" type="password" name="confirmpassword" class="validate" autocomplete="off" required>
                                            <label for="confirmPassword">ยืนยันรหัสผ่าน</label>
                                            <span toggle="#confirmPassword" class="field-icon toggle-password"><i class="material-icons">visibility</i></span>
                                        </div>
                                    ...
                                    <script>
                                        document.querySelectorAll('.toggle-password').forEach(function(icon) {
                                            icon.addEventListener('click', function() {
                                                const inputField = document.querySelector(icon.getAttribute('toggle'));
                                                if (inputField.type === 'password') {
                                                    inputField.type = 'text';
                                                    icon.querySelector('i').textContent = 'visibility_off';
                                                } else {
                                                    inputField.type = 'password';
                                                    icon.querySelector('i').textContent = 'visibility';
                                                }
                                            });
                                        });
                                    </script>
