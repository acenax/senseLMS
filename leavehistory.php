                        ...
                        <div class="card-content">
                            ...
                            <table id="example" class="display responsive-table ">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th width="300">ประเภทการลา</th>
                                        <th width="80">วันที่</th>
                                        <th width="250">ถึงวีนที่</th>
                                        <th width="200">โพสต์เมื่อวันที่</th>
                                        <th>การทำงาน</th>
                                    </tr>
                                </thead>
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            <tr>
                                                ...
                                                <td style="color: red;"><?php echo htmlentities($result->LeaveType); ?></td>
                                                <td><?php echo htmlentities($result->FromDate); ?></td>
                                                <td><?php echo htmlentities($result->ToDate); ?></td>
                                                <td><?php echo htmlentities($result->PostingDate); ?></td>
                                                <td>
                                                    <a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>" class="waves-effect waves-light btn blue m-b-xs"> ดูลายระเอียด</a>
                                                </td>
                                            </tr>
                                    <?php $cnt++;
                                        }
