     <aside id="slide-out" class="side-nav white fixed">
         <div class="side-nav-wrapper">
                     ...
                     <?php
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) {               ?>
                             ...
                             <span>รหัสพนักงาน<br><?php echo htmlentities($result->EmpId) ?></span>
                     <?php }
                        } ?>
                 </div>
             </div>
             ...
             <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                 ...
                 <li class="no-padding">
                     <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>หมวดการลา<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                     <div class="collapsible-body">
                         <ul>
                             <li><a href="apply-leave.php">ยื่นใบลา</a></li>
