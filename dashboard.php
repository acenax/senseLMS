                ...
                <div class="row no-m-t no-m-b">
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content">
                                    <span class="card-title">การลาทั้งหมด</span>
                    ...
                    <a href="leavehistory.php" target="blank">
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content">
                                    <span class="card-title">ลาป่วย</span>
                    ...
                    <a href="leavehistory.php" target="blank">
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content">
                                    <span class="card-title">ลากิจ</span>
                    ...
                    <a href="leavehistory.php" target="blank">
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content">
                                    <span class="card-title">ลาพักร้อน</span>
                                    <?php
                                    $sql = "SELECT id from  tblleaves where Status=1 and empid ='$eid'";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                    ...
                    <!-- <a href="leavehistory.php" target="blank">
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content">
                                    <span class="card-title">leavehistory</span>
                                    <?php
                                    $sql = "SELECT id from  tblleaves where Status=1 and empid ='$eid'";
                                    $query = $dbh->prepare($sql);
                                    $query->execute();
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="180">ลงเมื่อวันที่</th>
                                            <!-- <th align="right">การทำงาน</th> -->
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>" class="waves-effect waves-light btn blue m-b-xs"> ดูลายละเอียด</a></td>
                                                </tr>
                                        <?php $cnt++;
                                            }
                                        } ?>
