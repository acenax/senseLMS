...
?>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">แก้ไขตำแหน่ง</div>
                </div>
                            ...
                            <div class="row">
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    ...
                                                    <label for="deptname">ชื่อตำแหน่ง</label>
                                                </div>
                                                ...
                                                <div class="input-field col s12">
                                                    ...
                                                    <label for="deptshortname">ชื่อย่อ</label>
                                                </div>
                                                <div class="input-field col s12">
                                                    ...
                                                    <label for="password">รหัสตำแหน่ง</label>
                                                </div>
                                        ...
                                        <div class="input-field col s12">
                                            <button type="submit" name="update" class="waves-effect waves-light btn indigo m-b-xs">อัพเดท</button>
