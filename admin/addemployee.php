                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <p>วันเกิด</p>
                                                            <input id="birthdate" name="dob" type="date" autocomplete="off">
                                                        </div>
                                                        ...
                                                        <div class="input-field col s12">
                                                            <button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">เพิ่ม</button>
